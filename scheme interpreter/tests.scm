...
(define (pop lst) (car lst))
; expect pop

(define lst (cons 3 (cons 4 (cons 5 nil))))
; expect lst
...
(1 3 5 6 7 73)
; expect Error: int is not callable: 1
...
(begin (cons 3 (cons (* 2 3) (cons 4 nil))) 42)
; expect 42

(define (truth bool) (begin #f True))
; expect truth
...
(lambda (x) (truth x))
; expect (lambda (x) (truth x))

(define truther (lambda (x) (truth x)))
; expect truther
...
(and (counter 6) (counter 2))
; expect 2

(or #f (and (counter 10) #f))
; expect False
